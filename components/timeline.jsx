      ...
      <div class="flex flex-col md:grid grid-cols-9 mx-auto p-2 mt-2 text-blue-50 mb-4">
        <div class="flex flex-row-reverse md:contents">
          <div class="bg-indigo-500 col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md">
            <h3 class="font-semibold text-lg mb-1">1 Nov 2023 to 15 Nov 2023: Registration Period</h3>
            <p class="leading-tight text-justify">
            Participants are required to register through Devfolio or UnStop and submit their resumes.
            </p>
          </div>
        ...
        <div class="flex md:contents">
          ...
          <div class="bg-indigo-500 col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md">
            <h3 class="font-semibold text-lg mb-1">15 Nov 2023 to 17 Nov 2023: Shortlisting of teams</h3>
            <p class="leading-tight text-justify">
            20 teams will be shortlisted, who will participate in the offline hackathon.
            </p>
          </div>
        </div>
        ...
        <div class="flex flex-row-reverse md:contents">
          <div class="bg-indigo-500 col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md">
            <h3 class="font-semibold text-lg mb-1">18 Nov 2023: Shortlisted Teams Announcement</h3>
            <p class="leading-tight text-justify">
        ...
        <div class="flex md:contents">
          ...
          <div class="bg-indigo-500 col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md">
            <h3 class="font-semibold text-lg mb-1">18 Nov 2023 to 23 Nov 2023: Waiting period</h3>
            <p class="leading-tight text-justify">
        ...
        <div class="flex flex-row-reverse md:contents">
          <div class="bg-indigo-500 col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md">
            <h3 class="font-semibold text-lg mb-1">24 Nov 00:00 AM: Problem Statement Announcement</h3>
            <p class="leading-tight text-justify">
