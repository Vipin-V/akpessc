...
const ContactUs = () => {
  return (
    <>
    <div className="flex flex-col md:flex-row items-center mt-10 gap-x-20" style={{ perspective: 2000 }}>
      ...
      <div className="mt-10">
      <footer class=" bg-opacity-40 bg-slate-900 lg:grid lg:grid-cols-5 rounded-2xl">
  ...
  <div class="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
    <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
      <div>
        <p>
          <span class="text-xl uppercase tracking-wide text-gray-200 font-semibold">
            Contact Us
          </span>
        ...
        <ul class="mt-8 space-y-1 text-sm text-gray-300">
    ...
    <div class="mt-12 border-t border-gray-100 pt-12">
      <div class="sm:flex sm:items-center sm:justify-between">
        ...
        &copy; {new Date().getFullYear()}. Hack-a-Sol. All rights reserved.
        </p>
      </div>
    </div>
  </div>
