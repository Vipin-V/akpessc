...
const ContactUs = () => {
  return (
    <>
      ...
      <div className="mt-10">
        <footer class=" bg-opacity-80 bg-slate-900 lg:grid lg:grid-cols-5 rounded-2xl py-3">
          <div class="relative   lg:col-span-2 lg:h-full">
            <h1 className="block md:hidden text-center mt-4 text-4xl text-violet-600" style={myFont.style}>Hack-A-SOl</h1>
            <Image
              src="/logo.png"
              alt=""
            ...
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
              <div>
                ...
                <ul class="mt-8 space-y-1   text-gray-300 ">
                  <li className="font-semibold tetx-xl">Hack-A-Sol IIIT Naya Raipur </li>
